...
var
  gformMain: TgformMain;

implementation

uses
  System.IOUtils, Vcl.Dialogs, SecondaryForm, fmain;

{$R *.dfm}
//{$R GoogleMapsTest_Icon.ico}
...
procedure TgformMain.FormCreate(Sender: TObject);
begin
  ...
  //FileEdit.Text := ExtractFilePath(Application.ExeName)+'..\..\Data\customer.xml';
   FileEdit.Text := ExtractFilePath(Application.ExeName)+'examples\customer.xml';
  ...
  //Icon.Handle := LoadIcon(HInstance, 'XGMAPS');
   if fileExists ('.\GAPIKEY.INC') then begin {$I .\GAPIKEY.INC}

     TEdgeGoogleMapViewer.RegisterGoogleMapsApiKey(GOOGLE_APIKEY);
     maxform1.memo2.Lines.Add('TEdgeGoogleMapViewer API Key load from GAPIKEY.INC [Const GOOGLE_APIKEY =]');
     //ShowMessage('TEdgeGoogleMapViewer API Key load');
  end else
       maxform1.memo2.Lines.Add('TEdgeGoogleMapViewer API Key file GAPIKEY.INC missing [Const GOOGLE_APIKEY =]');
  //;


end;

procedure TgformMain.OnMapClick(ASender : TObject;  ALatLng : TLatLng);
begin
...
procedure TgformMain.OnMapRightClick(ASender : TObject; ALatLng : TLatLng);
begin
...
procedure TgformMain.OnMapZoom(ASender: TObject; AZoom: integer);
begin
  Zoom.Value := AZoom;
end;

procedure TgformMain.FormDestroy(Sender: TObject);
begin
  activeoleControl := nil;
end;

procedure TgformMain.FormShow(Sender: TObject);
begin
  ButtonGotoAddressClick(Sender);
end;

procedure TgformMain.HideMapButtonClick(Sender: TObject);
begin
  EdgeGoogleMapViewer.HideMap;
end;

procedure TgformMain.LoadTableButtonClick(Sender: TObject);
begin
  cdsCustomers.LoadFromFile(FileEdit.Text);
end;

procedure TgformMain.MapTypeIdComboBoxChange(Sender: TObject);
begin
  EdgeGoogleMapViewer.MapTypeId := TGoogleMapTypeId(MapTypeIdComboBox.ItemIndex);
end;

procedure TgformMain.mnuAddMarkerClick(Sender: TObject);
begin
  EdgeGoogleMapViewer.PutMarker(FRighClickLatLng,'Added from right click menu');
end;

procedure TgformMain.ShowPrintUIButtonClick(Sender: TObject);
begin
  EdgeGoogleMapViewer.ShowPrintUI;
end;

procedure TgformMain.ShowMapButtonClick(Sender: TObject);
begin
  EdgeGoogleMapViewer.GotoAddress(MemoAddress.Lines.Text);
end;

procedure TgformMain.ZoomChange(Sender: TObject);
begin
  EdgeGoogleMapViewer.MapZoom := Zoom.Value;
end;

procedure TgformMain.ButtonGotoLocationClick(Sender: TObject);
var
  Location: TLatLng;
begin
...
procedure TgformMain.CheckBoxFullScreenClick(Sender: TObject);
begin
  EdgeGoogleMapViewer.MapShowFullScreenControl :=
    CheckBoxFullScreen.Checked;
end;

procedure TgformMain.CheckBoxMapTypeClick(Sender: TObject);
begin
  EdgeGoogleMapViewer.MapShowTypeControl :=
    CheckBoxMapType.Checked;
end;

procedure TgformMain.CheckBoxZoomClick(Sender: TObject);
begin
  EdgeGoogleMapViewer.MapShowZoomControl :=
    CheckBoxZoom.Checked;
end;

procedure TgformMain.chMarkerShowHideClick(Sender: TObject);
begin
...
procedure TgformMain.chPolygonsShowHideClick(Sender: TObject);
begin
...
procedure TgformMain.chPolylinesShowHideClick(Sender: TObject);
begin
...
procedure TgformMain.cbxTravelModeChange(Sender: TObject);
begin
  EdgeGoogleMapViewer.MapRouteModeId := TGoogleRouteModeId(cbxTravelMode.ItemIndex);
end;

procedure TgformMain.cdsCustomersAfterScroll(DataSet: TDataSet);
var
  Address: string;
begin
...
procedure TgformMain.ButtonRouteByAddressClick(Sender: TObject);
begin
...
procedure TgformMain.ButtonRouteLatLngClick(Sender: TObject);
begin
  EdgeGoogleMapViewer.MapShowDirectionsPanel := CheckBoxDirectionPanel.Checked;
...
procedure TgformMain.btnAddCircleClick(Sender: TObject);
var
  LLatLng : TLatLng;
begin
...
procedure TgformMain.btnAddMarkerClick(Sender: TObject);
var
  LLatLng : TLatLng;
  LCustomJSON : string;
...
procedure TgformMain.btnAddPolygonClick(Sender: TObject);
begin
...
procedure TgformMain.btnAddPolylineClick(Sender: TObject);
begin
...
procedure TgformMain.btnClearCirclesClick(Sender: TObject);
begin
  EdgeGoogleMapViewer.ClearCircles;
end;

procedure TgformMain.btnClearPolygonsClick(Sender: TObject);
begin
  EdgeGoogleMapViewer.ClearPolygons;
end;

procedure TgformMain.btnClearPolylinesClick(Sender: TObject);
begin
  EdgeGoogleMapViewer.ClearPolylines;
end;

procedure TgformMain.btnGeometryComputeDistanceBetweenClick(Sender: TObject);
var
...
procedure TgformMain.Button1Click(Sender: TObject);
var
...
procedure TgformMain.ButtonClearMarkersClick(Sender: TObject);
begin
  EdgeGoogleMapViewer.ClearMarkers;
end;

procedure TgformMain.ButtonGotoAddressClick(Sender: TObject);
begin
  EdgeGoogleMapViewer.GotoAddress(MemoAddress.Lines.Text);
end;

procedure TgformMain.CheckBoxStreeViewClick(Sender: TObject);
begin
  EdgeGoogleMapViewer.ShowStreetViewControl(CheckBoxStreeView.Checked);
end;

procedure TgformMain.chCirclesShowHideClick(Sender: TObject);
begin
...
procedure TgformMain.CheckBoxBicyclingClick(Sender: TObject);
begin
  EdgeGoogleMapViewer.ShowBicycling(CheckBoxBicycling.Checked);
 end;


procedure TgformMain.CheckBoxDirectionPanelClick(Sender: TObject);
begin
  EdgeGoogleMapViewer.ShowDirectionsPanel(CheckBoxDirectionPanel.Checked);
end;

procedure TgformMain.CheckBoxTrafficClick(Sender: TObject);
begin
  EdgeGoogleMapViewer.ShowTraffic(CheckBoxTraffic.Checked);
 end;

procedure TgformMain.EdgeGoogleMapViewerBeforeShowMap(Sender: TObject);
begin
  if TEdgeGoogleMapViewer.ApiKey = '' then
    raise Exception.Create('Error: you must put your Google APIKey into TEdgeGoogleMapViewer or set in GAPIKEY.INC: [Const GOOGLE_APIKEY = ''yourapikey''] !');
end;

procedure TgformMain.EdgeGoogleMapViewerContainsFullScreenElementChanged(
  Sender: TCustomEdgeBrowser; ContainsFullScreenElement: Boolean);
begin
